        ...
        if ("function" != typeof i.onWarn) {
            var k = i.countdownMessage
                ...
                l = i.countdownBar
                    ...
                    : "";
            a("body").append(
                '<div class="modal fade p-5" id="session-timeout-dialog">               <div class="modal-dialog">                 <div class="modal-content">                   <div class="modal-header">                     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>                     <h4 class="modal-title">' +
                    i.title +
