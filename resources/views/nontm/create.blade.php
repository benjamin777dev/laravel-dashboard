...
@section('content')
                    ...
                    <div id="carouselExampleControls" class="carousel slide" data-interval="false">
                        ...
                        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                            <div class="row carousel-indicators text-center">
                                <div class="col-md-4 ">
                                    <div class="prev_btn">
                                        <a href="#" id="customPrevBtn"><h4 class="prev">< Previous</h4></a>
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="bullets">
                                ...
                                <div class="col-md-3 ">
                                    <div class="next_btn">
                                        <a href="#" id="customNextBtn"><h4 class="next">Next ></h4></a>
                                    </div>
                                </div>
                            </div>
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class=" pb-3 1st-form">
                                ...
                                <div class="carousel-item">
                                    <div class="main_form_div pb-5 2ndform">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            document.getElementById('customPrevBtn').addEventListener('click', function (event) {
                event.preventDefault();
                var carousel = new bootstrap.Carousel(document.getElementById('carouselExampleDark'));
                carousel.prev();
            });
    
            document.getElementById('customNextBtn').addEventListener('click', function (event) {
                event.preventDefault();
                var carousel = new bootstrap.Carousel(document.getElementById('carouselExampleDark'));
                carousel.next();
            });
