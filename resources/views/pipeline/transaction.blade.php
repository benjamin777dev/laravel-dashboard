                    ...
                    <tbody>
                        <tr class="npcontacts-Body">
                            <td class="commonTextEllipsis"
                                ...
                                id="deal_name{{ $deal['zoho_deal_id'] }}">{{ $deal['deal_name'] ?? 'N/A' }}</td>
                            <td class="commonTextEllipsis"
                            ...
                            <td class="commonTextEllipsis"
                                ...
                                {{ number_format($deal['sale_price'] ?? '0', 0, '.', ',') }}</td>
                            <td onclick="updateDeal('{{ $deal['zoho_deal_id'] }}','closing_date','{{ $deal['id'] }}')"
                                id="closing_date{{ $deal['zoho_deal_id'] }}">
                                {{ \Carbon\Carbon::parse($deal['closing_date'])->format('Y-m-d') ?? 'N/A' }}</td>
                            <td>
    ...
    @if (count($deals) > 0)
        @foreach ($deals as $deal)
            <div class="pTableCard">
                ...
                <div class="d-flex justify-content-between psellDivnew">
                ...
                <div class="d-flex justify-content-between psellDiv psellDivnew">
