...
class CreateContactTable extends Migration
{
    public function up()
    {
        Schema::create('contacts', function (Blueprint $table) {
            ...
            $table->decimal('residual_cap', 10, 2)->nullable();
            $table->decimal('residual_split', 5, 2)->nullable();
            $table->boolean('review_generation')->default(false);
            $table->string('salesforce_id')->nullable();
            $table->string('salutation')->nullable();
            $table->string('sign_install')->nullable();
            $table->string('secondary_email')->nullable();
            $table->string('select_your_prints')->nullable();
            $table->string('sign_vendor_if_other')->nullable();
            $table->string('sign_vendor')->nullable();
            $table->string('skype_id')->nullable();
            $table->boolean('social_media_ads')->default(false);
            $table->boolean('social_media_images')->default(false);
            $table->unsignedBigInteger('spouse_partner')->nullable();
            $table->string('status')->nullable();
            $table->string('sticky_dots')->nullable();
            ...
            $table->boolean('transaction_deadline_emails')->default(false);
            $table->unsignedBigInteger('transaction_manager')->nullable();
            $table->boolean('transaction_status_reports')->default(false);
            $table->unsignedBigInteger('transactions_as_primary_contact')->nullable();
            $table->string('twitter')->nullable();
            $table->string('twitter_url')->nullable();
            $table->boolean('unsubscribe_from_reviews')->default(false);
            $table->boolean('unsubscribed')->default(false);
            $table->unsignedBigInteger('user')->nullable();
            $table->string('using_chr_tm')->nullable();
            $table->unsignedBigInteger('visitor_score')->nullable();
            $table->date('weekly_email')->nullable();
