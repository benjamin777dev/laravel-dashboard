                    ...
                    <nav class="dtabs">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link dtabsbtn" data-tab='Overdue'
                                onclick="fetchTask('Completed','{{ $deal['id'] }}')" id="nav-contact-tab"
                                data-bs-toggle="tab" data-bs-target="#nav-contact" type="button" role="tab"
                                aria-controls="nav-contact" aria-selected="false">Overdue</button>
                        </div>
                    </nav>
            ...
            <div class="col-md-6 col-sm-12"
                ...
                <form class="row g-3" id="additionalFields">
                    <div class="col-md-6 selectSearch">
                        ...
                        <select id="leadAgent" >
                            <option value="" disabled {{ empty($deal['leadAgent']) ? 'selected' : '' }}>Searching
                            </option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select npinputinfo" id="validationDefault12" required>
                            ...
                            <option value="Lease" {{ $deal['property_type'] == 'Lease' ? 'selected' : '' }}>Lease
                            </option>
                        </select>
                    </div>
