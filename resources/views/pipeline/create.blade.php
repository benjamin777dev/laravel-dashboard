                ...
                <p class="npinfoText">Earnings Information</p>
                    <form class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control npinputinfo" id="contactName" value="{{ isset($deal['contactName']) ? $deal['contactName']['first_name'] . ' ' . $deal['contactName']['last_name'] : '' }}" disabled/>
