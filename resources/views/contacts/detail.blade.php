            ...
            <form class="row" action="{{ route('update.contact', ['id' => $contact->id]) }}" method="POST">
                ...
                <div class="col-md-6 col-sm-12"
                    ...
                    <div class="commonFlex ncgroupdiv">
                        ...
                        <div class="npbtnsDiv">
                            ...
                            <div class="input-group-text text-white justify-content-center ncAssignBtn"
                                data-bs-toggle="modal" data-bs-target="#staticBackdropforViewGroupforDetails">
                        ...
                        <div class="col-md-3 col-sm-3 col-3">
                            <div class="commonFlex">
                                <p class="mb-0">Group Name</p><img src="{{ URL::asset('/images/swap_vert.svg') }}"
                                    alt="Close icon" onclick="toggleSortGroup('name')" class="ppiplineSwapIcon"
                                    id="pipelineSort">
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-3">
                            <div class="commonFlex">
                                <p class="mb-0">Is Public? </p><img src="{{ URL::asset('/images/swap_vert.svg') }}"
                                    alt="Close icon" onclick="toggleSortGroup('isPublic')" class="ppiplineSwapIcon"
                                    id="pipelineSort">
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-3 ">
                            <div class="commonFlex">
                                <p class="mb-0">IsABC </p><img src="{{ URL::asset('/images/swap_vert.svg') }}"
                                    alt="Close icon" onclick="toggleSortGroup('isABCD')" class="ppiplineSwapIcon"
                                    id="pipelineSort">
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-3 col-3 ">
                            <div class="commonFlex">
                                <p class="mb-0">ID No. </p><img src="{{ URL::asset('/images/swap_vert.svg') }}"
                                    alt="Close icon" onclick="toggleSortGroup('id')" class="ppiplineSwapIcon"
                                    id="pipelineSort">
                            </div>
                        </div>
                    </div>
                    <div class="group_container">
                        ...
                        <p class="text-center mt-3">No groups found</p>
                    @else
                        @foreach ($contactsGroups as $contactGroup)
                            @foreach ($contactGroup['groups'] as $group)
                                <div class="row ncGroupBody" id="groupContainer{{ $group['group']['id'] }}">
