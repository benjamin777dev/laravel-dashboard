...
@section('title') @lang('Candidate') @lang('Overview') @endsection
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="text-truncate font-size-15"><a href="javascript: void(0);" class="text-dark">zPortal Dashboard UI</a></h5>
