                    ...
                    <nav class="dtabs">
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            <button class="nav-link dtabsbtn active" id="nav-home-tab" data-bs-toggle="tab"
                                data-bs-target="#nav-home" onclick="fetchTask('In Progress','{{$deal['id']}}')" data-tab='In Progress'
                                type="button" role="tab" aria-controls="nav-home" aria-selected="true">In
                                Progress</button>
                            <button class="nav-link dtabsbtn" data-tab='Not Started' onclick="fetchTask('Not Started','{{$deal['id']}}')"
                                id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button"
                                role="tab" aria-controls="nav-profile" aria-selected="false">Upcoming</button>
                            <button class="nav-link dtabsbtn" data-tab='Overdue' onclick="fetchTask('Completed','{{$deal['id']}}')"
                                id="nav-contact-tab" data-bs-toggle="tab" data-bs-target="#nav-contact" type="button"
                                role="tab" aria-controls="nav-contact" aria-selected="false">Overdue</button>
                        </div>
                    </nav>
                ...
                <form class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select npinputinfo" id="tmName" required disabled>
                            @foreach ($users as $user)
                                <option value="{{ $user }}"
                                    {{ $deal['tm_name'] == $user['root_user_id'] ? 'selected' : '' }}>
                                    {{ $user['name'] }}
                                </option>
                            @endforeach
                        </select>
