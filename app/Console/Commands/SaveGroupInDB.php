...
class SaveGroupInDB extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:save-group-in-d-b';
    ...
    public function handle()
    {
        ...
        foreach ($users as $user) {
            ...
            $fields = 'Created_Time,Name,Owner,Is_Public,isABC';
            ...
            try {
                ...
                while ($hasMorePages) {
                    $response = $zoho->getGroupsData($criteria, $fields, $page, 200);
            ...
            $saveInDB->storeGroupsIntoDB($allContactGroups,$user);
        }
    }
}
