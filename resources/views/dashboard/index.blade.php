...
@section('content')
    ...
    <div class="loader-overlay" id="loaderOverlay" style="display: none;"></div>
        ...
        <div class="row mt-3 text-center">
            ...
            <div class="col-ld-9 col-md-9 col-sm-12 dashboard-cards">
                 @include("components.dash-cards")
            </div>
        </div>
        <div class="section pt-0 pb-4">
                        ...
                        <div class="col-md-5 mt-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-column upcomming-task">
                                      @include("common.tasks.taskdash")
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-sm-12 dtasksection p-3">
