                ...
                <form id="noteForm_dash{{$deal['id']}}" action="{{ route('save.note') }}" method="post">
                    ...
                    <div class="modal-body dtaskbody">
                        ...
                        <div class="btn-group dmodalTaskDiv">
                            <select class="form-select dmodaltaskSelect" id="related_to{{ $deal['id'] }}" name="related_to"
                    ...
                    <div class="modal-footer dNoteFooter border-0">
                        <button type="button" id="validate-button{{ $deal['id'] }}"
                            onclick="validateNoteDash('{{ $deal['id'] }}')" class="btn btn-secondary dNoteModalmarkBtn">
            ...
            <div class="modal-content noteModal">
                ...
                <form id="noteForm_dash{{$contact['id']}}" action="{{ route('save.note') }}" method="post">
                    ...
                    <div class="modal-body dtaskbody">
                        ...
                        <p class="dRelatedText">Related to...</p>
                        <div class="btn-group dmodalTaskDiv">
                            <select class="form-select dmodaltaskSelect" id="related_to{{$contact['id']}}" name="related_to"
                                aria-label="Select Transaction">
                                @foreach ($retrieveModuleData as $item)
                    ...
                    <div class="modal-footer dNoteFooter border-0">
                        <button type="button" id="validate-button{{$contact['id']}}"
                            onclick="validateNoteDash('{{ $contact['id'] }}')" class="btn btn-secondary dNoteModalmarkBtn">
                            <i class="fas fa-save saveIcon"></i> Add Note
                        </button>
                    </div>
                </form>
